...
function adswth_breadcrumbs() {
	...
	$home_link   = home_url( '/' );
	$link_before = '<span typeof="v:Breadcrumb" class="br-item">';
	$link_after  = '</span>';
	...
	if ( is_front_page() || is_home() ) {
		...
		echo '<nav class="adswth-breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">';
		...
		if ( $show_home_link == 1 ) {
			...
			printf(
				'<a href="%1$s" rel="v:url" property="v:title" class="br-home">%2$s</a>%3$s',
				$home_link,
				$text[ 'home' ],
				$sprt
			);
