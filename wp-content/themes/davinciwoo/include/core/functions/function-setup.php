...
function adswth_scripts() {
	...
	wp_enqueue_style( 'davinciwoo-css-bootstrap-select', ADSW_THEME_URL .'/assets/css/front/bootstrap-select.min.css', [ 'davinciwoo-css-bootstrap' ], '1.13.2', 'all' );
	...
	if( is_woocommerce_activated() ){
		if( is_product() && ! adswth_option( 'product_gallery_woocommerce') ){
			...
			wp_enqueue_style( 'davinciwoo-css-flickity-fullscreen', ADSW_THEME_URL .'/assets/css/front/flickity.fullscreen.min.css', [ 'davinciwoo-css-flickity' ], '1.0.1', 'all' );
		}
