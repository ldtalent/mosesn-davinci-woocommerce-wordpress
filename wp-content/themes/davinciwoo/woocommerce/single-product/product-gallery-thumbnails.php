...
if ( $attachment_ids ) {
    ...
    if( $direction == 'normal' ) {
	    $gallery_class[] = 'row no-gutters row-small row-slider';
    ...
    <div class="<?php echo implode(' ', $gallery_class); ?>"
        data-flickity-options='{
                  ...
                  "wrapAround": false,
                  "autoPlay": false,
                  "prevNextButtons": <?php echo $thumb_count <= 5 ? 'false' : 'true' ?>,
                  "asNavFor": ".product-gallery-slider",
                  "percentPosition": true,
                  "imagesLoaded": true,
                  "lazyLoad": <?php echo $columns?>,
                  "pageDots": false,
                  "rightToLeft": <?php echo $rtl; ?>,
                  <?php if( $direction == 'vertical' ){ echo '"draggable": false,';} ?>
                  "contain": true
              }'
         data-count="<?php echo $thumb_count; ?>"
        ><?php
    ...
    foreach ( $attachment_ids as $attachment_id ) {
        ...
        echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<div class="col"><a class="image-wrap"><div class="image-inner">%s</div></a></div>', $image ), $attachment_id, $post->ID, $image_class );
