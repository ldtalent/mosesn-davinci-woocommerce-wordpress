	...
	<div class="product-main">
		<div class="row mb-0">
			<div class="product-gallery col-12 col-lg-6">
                <div class="product-gallery-inner direction-<?php echo adswth_option( 'product_image_style' ); ?> nav-position-<?php echo adswth_option( 'product_image_thumbnails_position' ); ?>">
				<?php
				/**
