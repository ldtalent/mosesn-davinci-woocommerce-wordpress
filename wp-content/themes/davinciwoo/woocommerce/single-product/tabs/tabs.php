		...
		<ul class="nav nav-tabs d-none d-md-flex" role="tablist">
			...
			<?php foreach ( $tabs as $key => $tab ) : ?>
				...
				<li class="<?php echo esc_attr( $key ); ?>_tab" id="tab-title-<?php echo esc_attr( $key ); ?>" >
					<a data-toggle="tab" href="#tab-<?php echo esc_attr( $key ); ?>" class="<?php echo $class; ?>"><?php echo apply_filters( 'woocommerce_product_' . $key . '_tab_title', esc_html( $tab['title'] ), $key ); ?></a>
				</li>
				<?php $count++; ?>
			<?php endforeach; ?>
		</ul>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a class="<?php echo $count == 0 ? '' : 'collapsed'; ?>" data-toggle="collapse" data-parent=".tab-pane" href="#acc-<?php echo esc_attr( $key ); ?>" aria-expanded="<?php echo $count == 0 ? 'true' : 'false'; ?>"><?php echo apply_filters( 'woocommerce_product_' . $key . '_tab_title', esc_html( $tab['title'] ), $key ); ?></a>
                            </h4>
                        </div>
