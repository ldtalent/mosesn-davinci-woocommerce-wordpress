...
$average       = ( $review_count > 0 ) ? $product->get_average_rating() : adswth_option( 'product_average_rating' );
...
<?php if( ( $rating_count > 0 && adswth_option( 'product_page_rating_show' ) ) || adswth_option( 'product_page_share_show' ) ) { ?>
