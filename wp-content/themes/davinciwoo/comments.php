...
if(!function_exists('theme_list_comment')){
    ...
    function theme_comment( $comment, $args, $depth ) {
        ...
        <div class="comm_one" id="comment-<?php comment_ID(); ?>">
            ...
            <div class="comm_body">
                <?php if ($comment->comment_approved == '0') : ?>
                    <div class="alert alert-info margin-bottom"><?php _e('Your comment is awaiting moderation.', 'ads');?></div>
                <?php endif; ?>
                <?php comment_text(); ?>
            </div>
...
//output comments
    ...
    <div class="comm_cont">
        ...
        <?php if (have_comments()) : ?>
            ...
            <h5 class="bigH5"><?php _e( 'Comments', 'ads' ) ?> <span>(<?php echo get_comments_number(); ?>)</span></h5>
